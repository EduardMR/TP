...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Taskproy@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Taskproy API";

        private String description = "Taskproy API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "Taskproy";
