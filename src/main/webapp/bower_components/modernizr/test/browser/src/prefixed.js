describe('prefixed', function () {
  ...
  beforeEach(function (done) {
    ...
    testPropsAll = sinon.spy(function () {
      return 'fakeRule';
    });
    cssToDOM = sinon.spy(function () {
      return 'fakeRule';
    });
    atRule = sinon.spy(function () {
      return '@fakeRule';
    });
    ModernizrProto = {};

    define('ModernizrProto', [], function () {
      return ModernizrProto;
    });
    define('testPropsAll', [], function () {
      return testPropsAll;
    });
    define('cssToDOM', [], function () {
      return cssToDOM;
    });
    define('atRule', [], function () {
      return atRule;
    });
